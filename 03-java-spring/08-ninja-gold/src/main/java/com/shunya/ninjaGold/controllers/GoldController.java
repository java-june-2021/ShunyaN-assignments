package com.shunya.ninjaGold.controllers;
...
//		r.nextInt(50);
		...
		if(building.equals("farm")) {
			...
			if(goldThisTurn < 0) {
			activity.add(String.format("You entered a %s and lost %d gold %s, bitter...!", building, goldThisTurn, formatter.format(now)));
			} else {
			activity.add(String.format("You entered a %s and earned %d gold %s", building, goldThisTurn, formatter.format(now)));
			}
		}
